Public Class frmFutureFlights
    ...
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        Try
            ...
            'objParam.Value = cboPassengers.ValueMember
            ...
            'cmdSelect = New OleDb.OleDbCommand("uspCustomerFutureFlightsListbox", m_conAdministrator)
            'cmdSelect.CommandType = CommandType.StoredProcedure
            ...
            strSelect = " SELECT intFlightPassengerID , TF.* " &
                        " FROM TFlights as TF LEFT JOIN FlightPassengers  as TFP " &
                        " On TF.intFlightID = TFP.intFlightID " &
                        " Join TPassengers As TP " &
                        "  On TFP.intPassengerID = TP.intPassengerID " &
                        "  WHERE dtmFlightDate >= GETDATE() " &
